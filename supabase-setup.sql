-- ============================================================
-- LearnHub — Complete Supabase Setup
...
INSERT INTO qbank_settings (id, qbank_visible) VALUES (1, true)
    ON CONFLICT (id) DO NOTHING;

INSERT INTO class_levels (name, description, icon, order_index, is_visible) VALUES
...
INSERT INTO flashcard_levels (name, description, icon, order_index) VALUES
...
INSERT INTO shortnote_levels (name, description, icon, order_index) VALUES
...
-- ── Done ─────────────────────────────────────────────────────
-- 35 tables created, all seed data inserted.
-- Your backend is now ready to connect to this Supabase database.
